...
static void draw_stats_menu_local(SDL_Renderer *renderer,
                                  TTF_Font *large_font,
                                  TTF_Font *score_font,
                                  TTF_Font *button_font,
                                  GameState *state);

static int draw_button(SDL_Renderer *renderer,
                       TTF_Font *font,
                       const char *text,
                       int x,
                       int y,
                                ...
                                AudioState *audio)
{
    ...
    while (running)
    {
        ...
        draw_main_menu(state->renderer,
                       state->large_font,
                       state->button_font,
                       state->settings.current_skin);

        int play_clicked = draw_button(state->renderer,
                                       state->button_font,
                                       "PLAY GAME",
                                       start_x,
                                       button_y,
                                       ...
                                       mouse_y,
                                       &mouse_clicked);
        int settings_clicked = draw_button(
            state->renderer,
            state->button_font,
            "SETTINGS",
            start_x,
                                    ...
                                    AudioState *audio)
{
    ...
    while (running)
    {
        ...
        draw_settings_menu(state->renderer,
                           state->large_font,
                           state->score_font,
                           state->button_font,
                           state,
        ...
        int skin_clicked = draw_button(state->renderer,
                                       state->button_font,
                                       skin_text,
                                       start_x,
                                       start_y,
...
static MenuState stats_menu_loop(GameState *state)
{
    ...
    while (running)
    {
        ...
        draw_stats_menu_local(state->renderer,
                              state->large_font,
                              state->score_font,
                              state->button_font,
                              state);

        int back_clicked = draw_button(state->renderer,
                                       state->button_font,
                                       "BACK",
                                       start_x,
                                       start_y,
                                  ...
                                  GameState *state)
{
    ...
    SDL_Surface *s1 =
        TTF_RenderText_Blended(score_font, buf, white);
    SDL_Texture *t1 =
        SDL_CreateTextureFromSurface(renderer, s1);
    ...
    SDL_Surface *s2 =
        TTF_RenderText_Blended(score_font, buf, white);
    SDL_Texture *t2 =
        SDL_CreateTextureFromSurface(renderer, s2);
    ...
    SDL_Surface *s3 =
        TTF_RenderText_Blended(score_font, buf, white);
    SDL_Texture *t3 =
        SDL_CreateTextureFromSurface(renderer, s3);
    ...
    SDL_Surface *s4 =
        TTF_RenderText_Blended(score_font, buf, white);
    SDL_Texture *t4 =
        SDL_CreateTextureFromSurface(renderer, s4);
    ...
    snprintf(buf,
             sizeof(buf),
             "Best Time: %.1fs",
             state->stats.best_time);
    SDL_Surface *s5 =
        TTF_RenderText_Blended(score_font, buf, gray);
    SDL_Texture *t5 =
        SDL_CreateTextureFromSurface(renderer, s5);
...
int main(int argc, char *argv[])
{
    ...
    while (running)
    {
        ...
        case MENU_SETTINGS:
            current_menu =
                settings_menu_loop(&state, &audio);
            break;
        case MENU_STATS:
        ...
        case MENU_GAME_OVER:
        {
            ...
            {
                current_menu =
                    game_over_loop(&state, game.score);
            }
            break;
        }
        }
