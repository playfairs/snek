...
static Color get_skin_color(SnakeSkin skin, int is_head)
{
    ...
    {
    case SKIN_BLUE:
        return is_head ? (Color){BLUE_R, BLUE_G, BLUE_B}
                       : (Color){70, 120, 200};
    case SKIN_RED:
        return is_head ? (Color){RED_R, RED_G, RED_B}
                       : (Color){200, 60, 60};
    case SKIN_RAINBOW:
        return is_head
                   ...
                   : (Color){ACCENT2_R,
                             ...
                             ACCENT2_B};
    case SKIN_PURPLE:
        return is_head ? (Color){180, 100, 255}
                       : (Color){140, 70, 200};
    case SKIN_GOLD:
        return is_head ? (Color){255, 215, 0}
                       : (Color){200, 160, 0};
    case SKIN_CYAN:
        return is_head ? (Color){0, 255, 255}
                       : (Color){0, 200, 200};
    case SKIN_NEON:
        return is_head ? (Color){255, 0, 255}
                       : (Color){200, 0, 200};
    case SKIN_HOLOGRAPHIC:
        return is_head ? (Color){215, 180, 255}
                       : (Color){170, 235, 255};
    case SKIN_MONOCHROME:
        return is_head ? (Color){220, 220, 220}
                       : (Color){110, 110, 110};
    case SKIN_CHROMATIC:
        return is_head ? (Color){240, 150, 255}
                       : (Color){90, 220, 240};
    case SKIN_COSMIC:
        return is_head ? (Color){190, 140, 255}
                       : (Color){40, 30, 80};
    case SKIN_CHROME:
        return is_head ? (Color){220, 225, 235}
                       : (Color){150, 170, 190};
    case SKIN_BUBBLE:
        return is_head ? (Color){190, 245, 255}
                       : (Color){140, 220, 235};
    case SKIN_SHADOW:
        return is_head ? (Color){140, 110, 190}
                       : (Color){40, 40, 65};
    case SKIN_SOLAR:
        return is_head ? (Color){255, 205, 60}
                       : (Color){220, 120, 35};
    case SKIN_AQUA:
        return is_head ? (Color){0, 200, 220}
                       : (Color){0, 140, 170};
    case SKIN_MIDNIGHT:
        return is_head ? (Color){90, 110, 170}
                       : (Color){25, 30, 55};
    default:
        return is_head ? (Color){GREEN_R, GREEN_G, GREEN_B}
                       : (Color){60, 160, 100};
    }
}

static Color get_skin_preview_color(SnakeSkin skin,
                                    int index,
                                    int is_head)
{
    ...
    case SKIN_HOLOGRAPHIC:
    {
        ...
        int r =
            clamp_color((int)(180 + 30 * sin(phase + 0.5)
                              + 10 * sin(2 * phase + 0.8)));
        int g =
            clamp_color((int)(190 + 28 * sin(phase + 1.2)
                              + 8 * sin(2 * phase + 0.6)));
        int b =
            clamp_color((int)(220 + 24 * sin(phase + 2.6)
                              + 6 * sin(2 * phase + 1.9)));
        return (Color){r, g, b};
    }
    case SKIN_MONOCHROME:
    ...
    case SKIN_CHROMATIC:
    {
        ...
        int g =
            clamp_color((int)(120 + 80 * sin(phase + 2.1)));
        int b =
            clamp_color((int)(200 + 55 * sin(phase + 4.2)));
        return (Color){r, g, b};
    }
    case SKIN_COSMIC:
    {
    ...
    {
        double shine =
            20 + 20 * fabs(sin(time + index * 0.3));
        return (Color){
            base.r + (int)shine > 255 ? 255
                                      : base.r + (int)shine,
            base.g + (int)shine > 255 ? 255
                                      : base.g + (int)shine,
            base.b + (int)shine > 255
                ? 255
                : base.b + (int)shine};
    }
    case SKIN_BUBBLE:
    {
        ...
        return (Color){
            base.r + (int)wave > 255 ? 255
                                     : base.r + (int)wave,
            base.g + (int)wave > 255 ? 255
                                     : base.g + (int)wave,
            base.b + (int)wave > 255 ? 255
                                     : base.b + (int)wave};
    }
    case SKIN_SHADOW:
    {
        int delta = (index % 2) * 12;
        return (Color){base.r + delta,
                       base.g + delta / 2,
                       base.b + delta};
    }
    case SKIN_SOLAR:
    ...
    case SKIN_AQUA:
    {
        ...
        return (Color){base.r,
                       base.g + (int)ripple > 255
                           ? 255
                           : base.g + (int)ripple,
                       base.b + (int)ripple > 255
                           ? 255
                           : base.b + (int)ripple};
    }
    case SKIN_MIDNIGHT:
    {
        double pulse =
            20 + 20 * sin(time * 0.5 + index * 0.2);
        return (Color){base.r,
                       base.g,
                       base.b + (int)pulse > 255
                           ? 255
                           : base.b + (int)pulse};
    }
    default:
...
static SDL_Rect draw_text(SDL_Renderer *renderer,
                          TTF_Font *font,
                          const char *text,
                          SDL_Color color,
                          int x,
...
static SDL_Rect draw_text_centered(SDL_Renderer *renderer,
                                   TTF_Font *font,
                                   const char *text,
                                   SDL_Color color,
                                   SDL_Rect bounds)
...
static void fill_rect(SDL_Renderer *renderer,
                      SDL_Rect rect,
                      Color color)
{
...
static void stroke_rect(SDL_Renderer *renderer,
                        SDL_Rect rect,
                        Color color)
{
    SDL_SetRenderDrawColor(renderer,
               ...
               int is_head)
{
    ...
    Color highlight = {color.r + (is_head ? 80 : 50) > 255
                           ? 255
                           : color.r + (is_head ? 80 : 50),
                       color.g + (is_head ? 80 : 50) > 255
                           ? 255
                           : color.g + (is_head ? 80 : 50),
                       color.b + (is_head ? 40 : 30) > 255
                           ? 255
                           : color.b + (is_head ? 40 : 30)};

    Color shadow = {color.r - (is_head ? 60 : 30) < 0
                        ? 0
                        : color.r - (is_head ? 60 : 30),
                    color.g - (is_head ? 40 : 20) < 0
                        ? 0
                        : color.g - (is_head ? 40 : 20),
                    color.b - (is_head ? 20 : 10) < 0
                        ? 0
                        : color.b - (is_head ? 20 : 10)};
...
void draw_grid(SDL_Renderer *renderer)
{
    ...
    for (int y = GAME_AREA_TOP; y < GAME_AREA_BOTTOM;
         y += SNAKE_BLOCK)
    {
...
void draw_powerup(SDL_Renderer *renderer, Powerup *powerup)
{
    ...
    double pulse = (SDL_GetTicks() % 1000) / 1000.0;
    int pulse_size =
        (int)(3 * (0.5 + 0.5 * sin(pulse * 2 * M_PI)));
    ...
    SDL_Rect powerup_rect = {powerup->pos.x,
                             powerup->pos.y,
                             SNAKE_BLOCK,
                             SNAKE_BLOCK};
    SDL_SetRenderDrawColor(renderer,
...
void draw_hud(SDL_Renderer *renderer,
              ...
              int current_speed,
              const ActivePowerup active_powerups[],
              int active_powerup_count,
              GameMode mode,
              double time_left,
              const char *last_powerup_text,
              ...
              double current_time)
{
    ...
    SDL_Surface *score_label_surf =
        TTF_RenderText_Blended(button_font,
                               score_label,
                               muted);
    SDL_Texture *score_label_tex =
        SDL_CreateTextureFromSurface(renderer,
                                     score_label_surf);
    SDL_Rect score_label_rect = {28,
                                 20,
                                 score_label_surf->w,
                                 score_label_surf->h};
    ...
    SDL_Surface *score_value_surf =
        TTF_RenderText_Blended(score_font,
                               score_value,
                               accent);
    SDL_Texture *score_value_tex =
        SDL_CreateTextureFromSurface(renderer,
                                     score_value_surf);
    SDL_Rect score_value_rect = {28,
                                 32 + score_label_rect.h
                                     - 4,
                                 score_value_surf->w,
                                 score_value_surf->h};
    SDL_RenderCopy(renderer,
    ...
    SDL_Texture *high_label_tex =
        SDL_CreateTextureFromSurface(renderer,
                                     high_label_surf);
    SDL_Rect high_label_rect = {
        DIS_WIDTH - high_label_surf->w - 28,
        20,
        high_label_surf->w,
        high_label_surf->h};
    SDL_RenderCopy(renderer,
    ...
    SDL_Texture *high_value_tex =
        SDL_CreateTextureFromSurface(renderer,
                                     high_value_surf);
    SDL_Rect high_value_rect = {
        DIS_WIDTH - high_value_surf->w - 28,
        32 + high_label_rect.h - 4,
        high_value_surf->w,
        high_value_surf->h};
    SDL_RenderCopy(renderer,
                   high_value_tex,
    ...
    SDL_Surface *mode_surf =
        TTF_RenderText_Blended(button_font,
                               mode_text,
                               white);
    SDL_Texture *mode_tex =
        SDL_CreateTextureFromSurface(renderer, mode_surf);
    SDL_Rect mode_rect = {mode_chip.x + 8,
                          mode_chip.y + 4,
                          mode_surf->w,
                          mode_surf->h};
    ...
    SDL_Texture *speed_tex =
        SDL_CreateTextureFromSurface(renderer, speed_surf);
    SDL_Rect speed_rect = {speed_chip.x + 8,
                           speed_chip.y + 4,
                           speed_surf->w,
                           speed_surf->h};
    ...
    chip_x += chip_width + chip_spacing;
    char apples_text[24];
    snprintf(apples_text,
             sizeof(apples_text),
             "APP %d",
             apples_collected);
    SDL_Rect apples_chip = {chip_x,
                            chip_y,
                            chip_width,
                            chip_height};
    SDL_SetRenderDrawColor(renderer, 22, 32, 44, 255);
    ...
    SDL_Surface *apples_surf =
        TTF_RenderText_Blended(button_font,
                               apples_text,
                               white);
    SDL_Texture *apples_tex =
        SDL_CreateTextureFromSurface(renderer, apples_surf);
    SDL_Rect apples_rect = {apples_chip.x + 8,
                            apples_chip.y + 4,
                            apples_surf->w,
                            apples_surf->h};
    SDL_RenderCopy(renderer,
    ...
    SDL_Surface *len_surf =
        TTF_RenderText_Blended(button_font,
                               len_text,
                               white);
    SDL_Texture *len_tex =
        SDL_CreateTextureFromSurface(renderer, len_surf);
    SDL_Rect len_rect = {len_chip.x + 8,
                         len_chip.y + 4,
                         len_surf->w,
                         len_surf->h};
    ...
    if (mode == MODE_TIME_ATTACK)
    {
        ...
        SDL_Texture *timer_tex =
            SDL_CreateTextureFromSurface(renderer,
                                         timer_surf);
        SDL_Rect timer_rect = {
            time_bg.x + (bar_width - timer_surf->w) / 2,
            time_bg.y - timer_surf->h - 4,
            timer_surf->w,
            timer_surf->h};
        SDL_RenderCopy(renderer,
                       timer_tex,
    ...
    {
        SDL_Rect pickup_rect = {DIS_WIDTH / 2 - 180,
                                HEADER_HEIGHT + 12,
                                360,
                                28};
        ...
        if (pickup_surf)
        {
            ...
            SDL_Rect pickup_text_rect = {
                pickup_rect.x
                    + (pickup_rect.w - pickup_surf->w) / 2,
                pickup_rect.y
                    + (pickup_rect.h - pickup_surf->h) / 2,
                pickup_surf->w,
                pickup_surf->h};
            SDL_RenderCopy(renderer,
                           pickup_tex,
    ...
    if (active_powerup_count > 0)
    {
        ...
        for (int i = 0; i < active_powerup_count; i++)
        {
            ...
            int col = i % 3;
            int power_x =
                base_x - col * (chip_width + chip_spacing);
            ...
            SDL_Texture *power_tex =
                SDL_CreateTextureFromSurface(renderer,
                                             power_surf);
            SDL_Rect power_rect = {power_chip.x + 10,
                                   power_chip.y + 3,
                                   power_surf->w,
                                   power_surf->h};
            SDL_RenderCopy(renderer,
                    ...
                    SnakeSkin current_skin)
{
    ...
    draw_text(renderer,
              button_font,
              "Fast, clean, bite-sized arcade survival.",
              muted,
              title_area.x,
              title_area.y + 52);
    ...
    for (int x = preview.x; x <= preview.x + preview.w;
         x += SNAKE_BLOCK)
    {
        SDL_RenderDrawLine(renderer,
                           x,
    ...
    for (int y = preview.y; y <= preview.y + preview.h;
         y += SNAKE_BLOCK)
    {
        SDL_RenderDrawLine(renderer,
                           preview.x,
    ...
    Powerup powerup_preview = {
        {preview_x + preview_powerup_col * SNAKE_BLOCK,
    ...
    Food bomb_preview = {
        {preview_x + preview_bomb_col * SNAKE_BLOCK,
    ...
    Food apple_preview = {
        {preview_x + preview_apple_col * SNAKE_BLOCK,
    ...
    draw_text(renderer,
              button_font,
              "WASD or arrows in game",
              muted,
              action_panel.x + 32,
              action_panel.y + 62);
    draw_text(renderer,
              button_font,
              "ESC pauses or backs out",
              muted,
              action_panel.x + 32,
              action_panel.y + 86);
}

void draw_settings_menu(SDL_Renderer *renderer,
                        TTF_Font *large_font,
                        TTF_Font *score_font,
                        TTF_Font *button_font,
                        GameState *state,
                        int current_option)
{
    ...
    draw_text(renderer,
              button_font,
              "Click a row to cycle its value.",
              muted,
              right_panel.x + 30,
              right_panel.y + 78);
    draw_text(renderer,
    ...
    SDL_Rect preview_box = {left_panel.x + 24,
                            left_panel.y + 112,
                            left_panel.w - 48,
                            190};
    ...
    for (int x = preview_box.x;
         x <= preview_box.x + preview_box.w;
         x += 20)
    {
        SDL_RenderDrawLine(renderer,
                           x,
    ...
    for (int y = preview_box.y;
         y <= preview_box.y + preview_box.h;
         y += 20)
    {
        SDL_RenderDrawLine(renderer,
                           preview_box.x,
                           y,
                           preview_box.x + preview_box.w,
                           y);
    }
    ...
    for (int i = 0; i < 8; i++)
    {
        ...
        Color preview_color = get_skin_preview_color(
    ...
    SDL_Rect details = {left_panel.x + 24,
                        left_panel.y + 330,
                        left_panel.w - 48,
                        208};
    ...
    draw_text(renderer,
              button_font,
              mode_names[state->settings.mode],
              white,
              details.x + 18,
              details.y + 58);
    draw_text(renderer,
              button_font,
              difficulty_names[state->settings.difficulty],
              white,
              details.x + 18,
              details.y + 86);
    draw_text(renderer,
              button_font,
              state->settings.sound_enabled ? "Sound on"
                                            : "Sound off",
              muted,
              details.x + 18,
              details.y + 122);
    draw_text(renderer,
              button_font,
              state->settings.music_enabled ? "Music on"
                                            : "Music off",
              muted,
              details.x + 18,
              details.y + 148);
                    ...
                    int score)
{
    ...
    SDL_Surface *title_surf =
        TTF_RenderText_Blended(large_font,
                               "GAME OVER",
                               accent);
    SDL_Texture *title_tex =
        SDL_CreateTextureFromSurface(renderer, title_surf);
    SDL_Rect title_rect = {(DIS_WIDTH - title_surf->w) / 2,
                           220,
                           title_surf->w,
                           title_surf->h};
    ...
    SDL_Texture *score_tex =
        SDL_CreateTextureFromSurface(renderer, score_surf);
    SDL_Rect score_rect = {(DIS_WIDTH - score_surf->w) / 2,
                           295,
                           score_surf->w,
                           score_surf->h};
    ...
    SDL_Surface *hint_surf = TTF_RenderText_Blended(
        button_font,
        "Hit PLAY AGAIN to try for a new high score.",
        gray);
    SDL_Texture *hint_tex =
        SDL_CreateTextureFromSurface(renderer, hint_surf);
    SDL_Rect hint_rect = {(DIS_WIDTH - hint_surf->w) / 2,
                          335,
                          hint_surf->w,
                          hint_surf->h};
