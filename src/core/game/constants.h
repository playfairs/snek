...
#define POWERUP_INITIAL_SPAWN_DELAY 5
#define POWERUP_SPAWN_DELAY_VARIANCE 10
#define POWERUP_DURATION_SPEED_BOOST 10
#define POWERUP_DURATION_SLOW_MO 10
#define POWERUP_DURATION_DOUBLE_POINTS 30
#define POWERUP_DURATION_INVINCIBLE 10
#define POWERUP_DURATION_PATHFIND 1500
#define POWERUP_DURATION_FRENZY 20
#define POWERUP_DURATION_MAGNET 1000
#define POWERUP_DURATION_FREEZE 5
#define POWERUP_DURATION_SHRINK 0
#define POWERUP_DURATION_GROW 0
#define POWERUP_DURATION_TELEPORT 0
#define POWERUP_DURATION_SPLIT 0
#define POWERUP_DURATION_RANDOM 0
#define FRENZY_FOOD_SPAWN_INTERVAL 4
